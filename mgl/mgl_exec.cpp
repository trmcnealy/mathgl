...
void mglc_addlegend(char out[1024], long n, mglArg *a, int k[10])
...
void mglc_addto(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_alpha(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_alphadef(char out[1024], long n, mglArg *a, int k[10])
...
void mglc_ambient(char out[1024], long n, mglArg *a, int k[10])
...
void mglc_area(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_aspect(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_axial(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_axialdir(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_axis(char out[1024], long n, mglArg *a, int k[10])
{
	register int i;
...
void mglc_ball(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3)
...
void mglc_box(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_bars(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)	
...
void mglc_belt(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_boxs(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_beam(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1 && k[4]==3)
...
void mglc_caxis(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_chart(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_cloud(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_crange(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_crop(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==3 && k[2]==3 && k[3]==2)
...
void mglc_cumsum(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_curve(char out[1024], long n, mglArg *a, int k[10])
{
	register long i;
	for(i=0;i<12;i++)	if(a[i].type!=2 || i>=n)	break;
	if(i==12)
...
void mglc_cut(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_crust(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1)
...
void mglc_colorbar(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_copy(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_cont(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_contf(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_cont3(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==2)
...
void mglc_contf3(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==2)
...
void mglc_conta(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_contfa(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_contx(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_contfx(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_conty(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_contfy(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_contz(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_contfz(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_cone(char out[1024], long n, mglArg *a, int k[10])
{
	bool ok=true;
	for(int i=0;i<7;i++)	if(a[i].type!=2)	ok=false;
	if(ok)
...
void mglc_dens(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_dens3(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==2)
...
void mglc_densa(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_densx(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_densy(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_densz(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_divto(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1)		sprintf(out,"%s /= %s;",a[0].s, a[1].s);
	else if(k[0]==1 && k[1]==3)	sprintf(out,"%s /= %g;",a[0].s, a[1].v);
}
...
void mglc_multo(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1)		sprintf(out,"%s *= %s;",a[0].s, a[1].s);
	else if(k[0]==1 && k[1]==3)	sprintf(out,"%s *= %g;",a[0].s, a[1].v);
}
...
void mglc_subto(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1)		sprintf(out,"%s -= %s;",a[0].s, a[1].s);
	else if(k[0]==1 && k[1]==3)	sprintf(out,"%s -= %g;",a[0].s, a[1].v);
}
...
void mglc_dots(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1)
...
void mglc_diff(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_diff2(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_drop(char out[1024], long n, mglArg *a, int k[10])
{
	register int i;
	for(i=0;i<7;i++)	if(k[i]!=3)	break;
	if(i==7)
...
void mglc_dew(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_fall(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_mesh(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_surf(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_surfc(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_surfa(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1 || k[1]!=1)	return;
	else if(k[2]!=1)
...
void mglc_flow(char out[1024], long n, mglArg *a, int k[10])
{
	int i;
	for(i=0;i<7;i++)	if(k[i]!=1)	break;
	if(i==2)
...
void mglc_fill(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_fog(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_font(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==2 && k[1]==3)
...
void mglc_grid(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_grid3(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==2)
...
void mglc_grida(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_light(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_line(char out[1024], long n, mglArg *a, int k[10])
{
	int i;
	if(n>5)
	{
...
void mglc_legend(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3)
...
void mglc_linewidth(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_legendbox(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_modify(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==2 && k[2]==1 && k[3]==1)
...
void mglc_max(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_min(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==2)
...
void mglc_sum(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==2)
...
void mglc_meshnum(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_marksize(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_mark(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1 || k[1]!=1)	return;
	else if(k[2]!=1)
...
void mglc_map(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_read(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_readmat(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==2)
...
void mglc_readall(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1 || k[1]!=2)	return;
	else if(k[2]==3 && k[3]==3)
...
void mglc_readhdf(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_rect(char out[1024], long n, mglArg *a, int k[10])
{
	long i;
	if(n>5)
	{
...
void mglc_resize(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1)
...
void mglc_rotate(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3 && k[3]==3)
...
void mglc_rotatetext(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_save(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_savehdf(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_smooth(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1)
...
void mglc_swap(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_set_id(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_stem(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_step(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_plot(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_squeeze(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==3)
...
void mglc_stfad(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==3)
...
void mglc_setsize(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && a[1].v>1 && a[0].v>1)
...
void mglc_sphere(char out[1024], long n, mglArg *a, int k[10])
{
	int i;
	for(i=0;i<7;i++)	if(k[i]!=3)	break;
	if(i==4)
...
void mglc_stfa(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==3)
...
void mglc_surf3(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
...
void mglc_surf3c(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1 || k[1]!=1)	return;
...
void mglc_surf3a(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1 || k[1]!=1)	return;
...
void mglc_subplot(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3)
...
void mglc_subdata(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==3)
...
void mglc_tile(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]!=1)	return;
	else if(k[1]!=1)
...
void mglc_text(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3 && k[3]==2)
...
void mglc_torus(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_transparent(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_transptype(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_transform(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==2 && k[2]==1 && k[3]==1)
...
void mglc_transforma(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==2 && k[2]==1 && k[3]==1)
...
void mglc_tube(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_textmark(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1 && k[4]==2)
...
void mglc_triplot(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_ternary(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_transpose(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_vectc(char out[1024], long n, mglArg *a, int k[10])
{
	int i;
	for(i=0;i<7;i++)	if(k[i]!=1)	break;
	if(i==2)
...
void mglc_vect(char out[1024], long n, mglArg *a, int k[10])
{
	int i;
	for(i=0;i<7;i++)	if(k[i]!=1)	break;
	if(i==2)
...
void mglc_xlabel(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_ylabel(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_zlabel(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_xrange(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1)
...
void mglc_yrange(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1)
...
void mglc_zrange(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1)
...
void mglc_xtick(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3)
		sprintf(out,"gr->dx = %g;\tgr->NSx = %d;\tgr->TOrg.x = %g;", a[0].v, int(a[1].v),a[2].v);
	else if(k[0]==3 && k[1]==3)	sprintf(out,"gr->dx = %g;\tgr->NSx = %d;", a[0].v, int(a[1].v));
...
void mglc_ytick(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3)
		sprintf(out,"gr->dy = %g;\tgr->NSy = %d;\tgr->TOrg.y = %g;", a[0].v, int(a[1].v),a[2].v);
	else if(k[0]==3 && k[1]==3)	sprintf(out,"gr->dy = %g;\tgr->NSy = %d;", a[0].v, int(a[1].v));
...
void mglc_ztick(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3)
		sprintf(out,"gr->dz = %g;\tgr->NSz = %d;\tgr->TOrg.z = %g;", a[0].v, int(a[1].v),a[2].v);
	else if(k[0]==3 && k[1]==3)	sprintf(out,"gr->dz = %g;\tgr->NSz = %d;", a[0].v, int(a[1].v));
...
void mglc_zoom(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3 && k[3]==3)
...
void mglc_error(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1)
...
void mglc_extend(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==3)
...
void mglc_info(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_integrate(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_inplot(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3 && k[3]==3)
...
void mglc_pipe(char out[1024], long n, mglArg *a, int k[10])
{
	int i;
	for(i=0;i<7;i++)	if(k[i]!=1)	break;
	if(i==2)
...
void mglc_origin(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3)
...
void mglc_plotfactor(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_norm(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==3 && k[2]==3)
...
void mglc_hist(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==3 && k[4]==3 && k[5]==3)
...
void mglc_mirror(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_new(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==3)
...
void mglc_var(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==3 && k[2]==3 && k[3]==3)
...
void mglc_chdir(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_perspective(char out[1024], long n, mglArg *a, int k[10])
{
...
void mglc_facex(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3 && k[3]==3 && k[4]==3)
		sprintf(out,"gr->FaceX(%g, %g, %g, %g, %g, \"%s\", %g, %g);", a[0].v, a[1].v, a[2].v, a[3].v, a[4].v, k[5]==2?a[5].s:"", k[6]==3?a[6].v:0, k[7]==3?a[7].v:0);
}
//-----------------------------------------------------------------------------
...
void mglc_facey(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3 && k[3]==3 && k[4]==3)
		sprintf(out,"gr->FaceY(%g, %g, %g, %g, %g, \"%s\", %g, %g);", a[0].v, a[1].v, a[2].v, a[3].v, a[4].v, k[5]==2?a[5].s:"", k[6]==3?a[6].v:0, k[7]==3?a[7].v:0);
}
//-----------------------------------------------------------------------------
...
void mglc_facez(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3 && k[3]==3 && k[4]==3)
		sprintf(out,"gr->FaceZ(%g, %g, %g, %g, %g, \"%s\", %g, %g);", a[0].v, a[1].v, a[2].v, a[3].v, a[4].v, k[5]==2?a[5].s:"", k[6]==3?a[6].v:0, k[7]==3?a[7].v:0);
}
//-----------------------------------------------------------------------------
...
void mglc_normsl(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==3 && k[2]==3)
		sprintf(out,"%s.NormSl(%g, %g, '%c', %s, %s);", a[0].s, a[1].v, a[2].v, k[3]==2?a[3].s[0]:'z', (k[4]!=3||a[4].v!=0)?"true":"false", (k[5]==3&&a[5].v!=0)?"true":"false");
}
//-----------------------------------------------------------------------------
...
void mglc_momentum(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==2)
		sprintf(out,"%s = %s.Momentum('%c', \"%s\");", a[0].s, a[1].s, k[3]==2?a[3].s[0]:'z', a[2].s);
}
//-----------------------------------------------------------------------------
...
void mglc_fit(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1 && k[4]==1&& k[5]==2 && k[6]==2)
		sprintf(out,"gr->Fit(%s, %s, %s, %s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, a[4].s, a[5].s, a[6].s, (k[7]==1 && a[7].d->nx>=strlen(a[6].s))?a[7].s:"NULL", (k[8]==3&&a[8].v!=0)?"true":"false");
	else if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1 && k[4]==2 && k[5]==2)
		sprintf(out,"gr->Fit(%s, %s, %s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, a[4].s, a[5].s, (k[6]==1 && a[6].d->nx>=strlen(a[5].s))?a[6].s:"NULL", (k[7]==3&&a[7].v!=0)?"true":"false");
	else if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==2 && k[4]==2)
		sprintf(out,"gr->Fit(%s, %s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, a[4].s, (k[5]==1 && a[5].d->nx>=strlen(a[4].s))?a[5].s:"NULL", (k[6]==3&&a[6].v!=0)?"true":"false");
	else if(k[0]==1 && k[1]==1 && k[2]==2 && k[3]==2)
		sprintf(out,"gr->Fit(%s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, (k[5]==1 && a[5].d->nx>=strlen(a[4].s))?a[5].s:"NULL", (k[6]==3&&a[6].v!=0)?"true":"false");
}
//-----------------------------------------------------------------------------
...
void mglc_fits(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1 && k[4]==1 && k[5]==1 && k[6]==2 && k[7]==2)
		sprintf(out,"gr->FitS(%s, %s, %s, %s, %s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, a[4].s, a[5].s, a[6].s, a[7].s, (k[8]==1 && a[8].d->nx>=strlen(a[7].s))?a[8].s:"NULL", (k[9]==3&&a[9].v!=0)?"true":"false");
	else if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1 && k[4]==1 && k[5]==2 && k[6]==2)
		sprintf(out,"gr->FitS(%s, %s, %s, %s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, a[4].s, a[5].s, a[6].s, (k[7]==1 && a[7].d->nx>=strlen(a[6].s))?a[7].s:"NULL", (k[8]==3&&a[8].v!=0)?"true":"false");
	else if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==1 && k[4]==2 && k[5]==2)
		sprintf(out,"gr->FitS(%s, %s, %s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, a[4].s, a[5].s, (k[6]==1 && a[6].d->nx>=strlen(a[5].s))?a[6].s:"NULL", (k[7]==3&&a[7].v!=0)?"true":"false");
	else if(k[0]==1 && k[1]==1 && k[2]==1 && k[3]==2 && k[4]==2)
		sprintf(out,"gr->FitS(%s, %s, %s, \"%s\", \"%s\", %s, %s);", a[0].s, a[1].s, a[2].s, a[3].s, a[4].s, (k[5]==1 && a[5].d->nx>=strlen(a[4].s))?a[5].s:"NULL", (k[6]==3&&a[6].v!=0)?"true":"false");
}
//-----------------------------------------------------------------------------
...
void mglc_putsfit(char out[1024], long n, mglArg *a, int k[10])
{
	if(k[0]==3 && k[1]==3 && k[2]==3)
		sprintf(out,"gr->PutsFit(mglPoint(%g, %g, %g), \"%s\", \"%s\", %g);", a[0].v,a[1].v,a[2].v, k[3]==2?a[3].s:"", k[4]==2?a[4].s:"", k[5]==3?a[5].v:-1);
	else if(k[0]==3 && k[1]==3)
		sprintf(out,"gr->PutsFit(mglPoint(%g, %g), \"%s\", \"%s\", %g);", a[0].v,a[1].v, k[2]==2?a[2].s:"", k[3]==2?a[3].s:"", k[4]==3?a[4].v:-1);
...
mglCommand mgls_base_cmd[] = {
	...
	{"fall","Draw waterfalls","fall {xvar yvar} zvar [fmt]", mgls_fall, mglc_fall},
	{"fill","Fill data linearly in range [v1, v2]","fill var v1 v2 [dir]", mgls_fill, mglc_fill},
	{"fit","Fit data to formula","fit res {x {y {z}}} a eq var [ini print]", mgls_fit, mglc_fit},
	{"fits","Fit data to formula","fits res {x {y {z}}} a s eq var [ini print]", mgls_fits, mglc_fits},
	...
	{"modify","Modify data values by formula","modify var formula [var1 var2]", mgls_modify, mglc_modify},
	{"momentum","Get momentum along direction","momentum odat idat dir how", mgls_momentum, mglc_momentum},
	{"multo","Multiply by data or number","multo var|num", mgls_multo, mglc_multo},
	{"new","Create new data","new var nx [ny nz]", mgls_new, mglc_new},
	{"norm","Normalize data","", mgls_norm, mglc_norm},
	{"normsl","Normalize data slice by slice","", mgls_normsl, mglc_normsl},
