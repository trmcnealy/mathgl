...
mglCommand mgls_base_cmd[] = {
	...
	{L"text",L"Draw text at some position or along curve",L"text x y 'txt' ['fnt' size]|x y z 'txt' ['fnt' size]|x y dx dy 'txt' ['fnt' size]|x y z dx dy dz 'txt' ['fnt' size]|\
		Ydat 'txt' ['font' sise zval]|Xdat Ydat 'txt' ['font' sise zval]", mgls_text, mglc_text, false, 0},
	{L"textmark",L"Draw TeX mark at point position",L"textmark Ydat Rdat 'text' ['fnt' zval]|Xdat Ydat Rdat 'text' ['fnt' zval]|Xdat Ydat Zdat Rdat 'text' ['fnt']", mgls_textmark, mglc_textmark, false, 0},
